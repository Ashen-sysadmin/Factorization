...
public class AllocationHandler {
     ...
     * 
     * A singly-linked list with references to the head of the list, and a 'rover' that walks the list as calls are made
    ...
    public void free(int start) {
        ...
        System.err.println(
            "AllocationHandler for " + name
                + " was asked to free area starting at "
                + start
