...
public class WrappedPacketFromClient extends WrappedPacket {
    ...
    public void processPacket(INetHandler handler) {
        ...
        // May possibly need to inject the liason into things up higher, during reading. Somehow. Hopefulloy won't be
        // needed.
        ...
        if (liason == null) {
            if (!(wrapped instanceof C00PacketKeepAlive)) {
                ...
                Hammer.logWarning(
                    "Liasonless wrapped packet: " + wrapped.getClass()
                        .getSimpleName() + " " + wrapped.serialize());
                return;
            }
        } else {
        ...
        if (wrapped instanceof FMLProxyPacket) {
            ...
            NetworkDispatcher dispatcher = nhps.netManager.channel()
