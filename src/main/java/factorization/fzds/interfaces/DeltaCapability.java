...
public enum DeltaCapability {
    ...
    ROTATE,
    /**
     * When the DSE moves, entities standing on it in real space will be moved with it. (Entities in shadow space, of
     * course, will naturally move along.)
     */
    DRAG,
    ...
    COLLIDE_WITH_WORLD,
    /**
     * When an ordered rotation completes, recalculate the orientation. For debugging; might also be useful if there are
     * precision issues
     */
