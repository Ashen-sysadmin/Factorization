...
public class BlockIcons {
    ...
    public static IIcon uv_test, default_icon, error;

    @Directory("material")
    public static IIcon transparent, wood;

    @Directory("resource")
    public static IIcon dark_iron_block, ore_dark_iron, ore_dark_iron_glint;

    @Directory("charge")
    public static IIcon motor_texture, wire, battery_bottom, battery_top, battery_side, battery_meter, boiler_side,
        boiler_top, mirror_front, mirror_side, mirror_beam, turbine_top, turbine_bottom, turbine_side, leyden_glass,
        leyden_glass_side, leyden_knob, caliometric_side, caliometric_top;
    ...
    @Directory("machine")
    public static IIcon heater_heat, heater_spiral, parasieve_front, parasieve_side, parasieve_back;
    ...
    @Directory("rocket")
    public static IIcon rocket_engine_top, rocket_engine_bottom_hole, rocket_engine_nozzle, rocket_engine_valid,
        rocket_engine_invalid;
    ...
    public static IIcon beauty$shaft_gen_top, beauty$shaft_gen_bottom, beauty$shaft_gen_bottom_on,
        beauty$shaft_gen_side, beauty$shaft_gen_side_on;
    public static IIcon beauty$water_top, beauty$water_bottom, beauty$water_side, beauty$wind_top, beauty$wind_bottom,
        beauty$wind_side;
    ...
    public static IIcon servo$one, servo$zero, servo$negative_one, servo$number, servo$sum, servo$product, servo$dup,
        servo$drop, servo$true, servo$false;
    ...
    public static IIcon servo$ctrl$shift_import, servo$ctrl$shift_export, servo$ctrl$shift_target_slot,
        servo$ctrl$shift_transfer_limit, servo$ctrl$shift_stream, servo$ctrl$shift_pulse_some,
        servo$ctrl$shift_pulse_exact, servo$ctrl$shift_probe;
    ...
    public static IIcon colossi$body, colossi$body_cracked, colossi$mask, colossi$mask_cracked, colossi$core,
        colossi$core_back, colossi$leg, colossi$eye, colossi$eye_open;
        ...
        public IIcon get(TileEntityFactorization tef, ForgeDirection dir) {
            switch (dir) {
                ...
                case DOWN:
                    return bottom;
                default:
                    return tef.draw_active > 0 ? side_on : side;
            }
        }
    }
        ...
        public IIcon get(TileEntityFactorization tef, ForgeDirection dir) {
            switch (dir) {
                ...
                case DOWN:
                    return bottom;
                default:
                    return tef.facing_direction == dir.ordinal() ? face : side;
            }
        }
    }
