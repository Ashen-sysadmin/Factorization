...
public class ItemBlockProxy extends ItemFactorization {
    ...
    // NOTE: Copied from ItemBlock, *EXCEPT* that in the final check, I've changed the AABB check is done w/ null
    // instead of the player.
    // Why is that even necessary...?
    // TODO: Fix this stupidity. Seems like every other release it gets messed up.
    // Ah! Might have something to do with clicking on blocks that have an incorrect return. At one point clicking on
    // colossal blocks made it place even if you were in front...
    @Override
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4,
        ...
        if (par1ItemStack.stackSize == 0) {
            ...
            return false;
        } else if (par5 == 255 && this.theBlock.getMaterial()
            .isSolid()) {
                return false;
            } else
            if (par3World.canPlaceEntityOnSide(this.theBlock, par4, par5, par6, false, par7, null, par1ItemStack)) {
                ...
                if (placeBlockAt(
                    ...
                    par3World.playSoundEffect(
                        ...
                        this.theBlock.stepSound.func_150496_b(),
                        (this.theBlock.stepSound.getVolume() + 1.0F) / 2.0F,
                        this.theBlock.stepSound.getPitch() * 0.8F);
