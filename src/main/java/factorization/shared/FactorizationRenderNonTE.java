...
public class FactorizationRenderNonTE implements ISimpleBlockRenderingHandler {
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId,
        ...
        int renderPass = 0; // MinecraftForgeClient.getRenderPass(); // Ohhh, look, that helpful method's returned! Like
                            // 2 years after I asked for it back! Except now it's broken. Great job, Forge.
        if (block instanceof IRenderNonTE) {
