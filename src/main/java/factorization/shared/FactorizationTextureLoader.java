...
public class FactorizationTextureLoader {
    ...
    /**
     * This annotation indicates that the IIcon is in a subdirectory. The following are equivalent, and will cause the
     * icon to be registered as "servo/catGrabber"
     * 
     * <pre>
            ...
            for (Field f : fields) {
                ...
                if (IIcon[].class.isAssignableFrom(f.getType())) {
                    ...
                    .isArray()) {
                        ...
                        Class<?> componentType = theArray.getClass()
                            .getComponentType();
                        for (int i = 0; i < len; i++) {
