...
import factorization.shared.coremod.AtVerifier;
...
public class Core {
    ...
    public static final String version = "@FZVERSION@"; // Modified by build script, but we have to live with this in
                                                        // dev environ.
    ...
    @SidedProxy(
        clientSide = "factorization.common.FactorizationClientProxy",
        serverSide = "factorization.common.FactorizationProxy")
    ...
    public static final boolean dev_environ = Launch.blackboard != null
    ...
    public static final boolean enable_test_content = dev_environ
        || Boolean.parseBoolean(System.getProperty("fz.enableTestContent"));
    ...
    public static void checkJar() {
        ...
        ModContainer mod = FMLCommonHandler.instance()
        ...
        if (src.isDirectory()) {
            throw new RuntimeException(
                "Factorization jar has been unpacked into a directory. Don't do that. Just put Factorization.jar in the mods/ folder");
        }
        ...
        if (success) {
            throw new RuntimeException(
                "The Factorization jar had an improper file extension. It has been renamed. Please restart Minecraft.");
        } else {
            throw new RuntimeException(
                "The Factorization jar has an improper file extension; it should be a .jar, not a .zip, and not a .jar.zip.");
        }
    }
    ...
    private static void validateEnvironment() {
        if (!LoadingPlugin.pluginInvoked) {
            String fml = "-Dfml.coreMods.load=factorization.shared.coremod.LoadingPlugin";
            ...
            if ("".equals(System.getProperty("fz.ignoreMissingCoremod", ""))) {
                ...
                throw new IllegalStateException(
                    "Coremod didn't load! Is your installation broken?\n"
                        + "Weird. It really is supposed to load, y'know...\n"
                        + "Anyways, try adding this flag to the JVM command line: "
                        + fml
                        + "\n"
                        + dev
                        ...
                        + "pass the following flag, but many things (including blowing up diamond blocks) will be broken: "
                        + ignore);
            } else {
    ...
    public void load(FMLPreInitializationEvent event) {
        ...
        FMLInterModComms
            .sendMessage(truth, "AddRecipeCategory", "Lacerator|factorization.oreprocessing.TileEntityGrinder|recipes");
        FMLInterModComms.sendMessage(
            truth,
            "AddRecipeCategory",
            "Crystallizer|factorization.oreprocessing.TileEntityCrystallizer|recipes");
        FMLInterModComms.sendMessage(
            truth,
            "AddRecipeCategory",
            "Slag Furnace|factorization.oreprocessing.TileEntitySlagFurnace$SlagRecipes|smeltingResults");
    ...
    void registerSimpleTileEntities() {
        ...
        EntityRegistry.registerModEntity(
            TileEntityWrathLamp.RelightTask.class,
            "fz_relight_task",
            0,
            Core.instance,
            1,
        ...
        EntityRegistry
            .registerModEntity(ColossusController.class, "fz_colossal_controller", 2, Core.instance, 256, 20, false);
        EntityRegistry
            .registerModEntity(EntityPoster.class, "fz_entity_poster", 3, Core.instance, 160, Integer.MAX_VALUE, false);
        ...
        EntityRegistry
            .registerModEntity(EntityGrabController.class, "fz_grab_controller", 8, Core.instance, 100, 1, true);
    ...
    public void modsLoaded(FMLPostInitializationEvent event) {
        ...
        for (FactoryType ft : FactoryType.values()) ft.getRepresentative(); // Make sure everyone's registered to the
                                                                            // EVENT_BUS
        proxy.afterLoad();
    ...
    public void replaceDerpyNames(FMLMissingMappingsEvent event) {
        ...
        Object[][] corrections = new Object[][] { { "factorization:tile.null", Core.registry.factory_block },
    ...
    ItemStack getExternalItem(String className, String classField, String description) {
        try {
            ...
            return (ItemStack) c.getField(classField)
                .get(null);
        } catch (Exception err) {
