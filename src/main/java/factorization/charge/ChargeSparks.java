...
public class ChargeSparks {
    ...
    public void spark(Vec3 src, Vec3 dest, int life, int stepTime, int depth, double variance, double width,
        int color) {
        SparkInfo info = take();
        info.src = src;
        info.dest = dest;
    ...
    private static Vec3 work = Vec3.createVectorHelper(0, 0, 0), work2 = Vec3.createVectorHelper(0, 0, 0),
        delta = Vec3.createVectorHelper(0, 0, 0);
