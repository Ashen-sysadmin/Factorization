...
public class BlockRenderRocketEngine extends FactorizationBlockRender {
    ...
    public boolean render(RenderBlocks rb) {
        ...
        IIcon nozzle = BlockIcons.rocket_engine_nozzle, bottom = BlockIcons.rocket_engine_bottom_hole,
            top = BlockIcons.rocket_engine_top;
        ...
        Tessellator tess = Tessellator.instance;
        {
            ...
            // tess.setBrightness(this.renderMinY > 0.0D ? l : par1Blocks.getMixedBrightnessForBlock(this.blockAccess,
            // par2, par3 - 1, par4));
        ...
        for (int i = 1; i < 4; i++) {
            ...
            block.setBlockBounds(d * i, (i - 1) * height, d * i, 2 - d * i, height * (i), 2 - d * i);
        ...
        block.setBlockBounds(0, b, 0, 2, 3, 2);
        block.beginWithRotatedUVs();
        block.renderRotated(tess, here);
        return true;
    }
