...
public class TileEntityGrinderRender {
    ...
    public static class DiamondModel {
        ...
        PositionTextureVertex down = new PositionTextureVertex(
            Vec3.createVectorHelper(near / 2, point, far / -3),
            dum,
            dvm), // the pointy end
            // numpad directions
        ...
        TexturedQuad makeQuad(PositionTextureVertex a, PositionTextureVertex b) {
            ...
            Vec3 mid = Vec3.createVectorHelper(
                (va.xCoord + vb.xCoord) / 2,
                (va.yCoord + vb.yCoord) / 2,
                (va.zCoord + vb.zCoord) / 2);
            ...
            return new TexturedQuad(
                new PositionTextureVertex[] { down, a, new PositionTextureVertex(mid, tmx, tmy), b });
        }
